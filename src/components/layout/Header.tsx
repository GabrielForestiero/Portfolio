...
const Header: React.FC<HeaderProps> = ({
    ...
    return (
        <>
                    ...
                    <div className="flex justify-between items-center h-20">
                        ...
                        <div className="flex items-center space-x-4">
                            <a href="#" className="flex items-center group cursor-pointer">
                                ...
                                <div className="ml-3">
                                    <span className={`text-xl font-mono font-bold text-white hidden sm:block transition-all duration-200 ${glitchActive ? 'animate-pulse text-cyan-400' : ''
                                        }`}>
                                        {title}
                                    </span>
                                </div>
            ...
            <div className={`md:hidden fixed left-0 right-0 top-20 z-40 transform transition-all duration-300 ease-in-out ${isMenuOpen ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0 pointer-events-none'
                }`}>
